...
class Orchestrator
  ...
  def initialize(pe_console, username: nil, password: nil, token: nil, ssl_verify: true, token_lifetime: nil)
    @pe_client = PeHttp.new(pe_console, port: 8143, username: username, password: password, token: token, ssl_verify: ssl_verify, token_lifetime: token_lifetime)
  end
